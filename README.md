...
You'll find a large set of expression and algebraic operator examples in the [Unit Tests](src/UnitTests/Tests.fs) (yes, they're actually very readable). A few examples:
